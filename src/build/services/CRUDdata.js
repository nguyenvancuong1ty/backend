...
var createUser = function createUser(_x) {
  return (_ref2 = _ref2 || _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req) {
...
var deleteUser = function deleteUser(_x2) {
  return (_ref3 = _ref3 || _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req) {
    var idUser, _yield$connection$que5, _yield$connection$que6, result, fields;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          _context3.next = 4;
          return connection.query(sql, [idUser]);
        case 4:
...
var updateUser = function updateUser(_x3) {
  return (_ref4 = _ref4 || _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req) {
    var _req$body2, email, name, city, idUser, _yield$connection$que7, _yield$connection$que8, result, fields;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _req$body2 = req.body, email = _req$body2.email, name = _req$body2.name, city = _req$body2.city;
          idUser = req.params.id;
          console.log(idUser);
          sql = 'update users set email = ?, name = ?, city = ? where id = ?';
          _context4.next = 6;
          return connection.query(sql, [email, name, city, idUser]);
        case 6:
...
var getUserById = function getUserById(_x4) {
  return (_ref5 = _ref5 || _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req) {
    var sql, idUser, _yield$connection$que9, _yield$connection$que10, result, fields;
